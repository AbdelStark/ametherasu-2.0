<template>
  <div class="wrapper">
    <side-bar title="Ametherasu 2.0">
      <template slot="links">
        <sidebar-link :name="$t('sidebar.dashboard')" icon="tim-icons icon-chart-pie-36" to="/dashboard"/>
        <sidebar-link :name="$t('sidebar.information')" icon="tim-icons icon-alert-circle-exc" to="/information"/>
        ...
        <sidebar-link :name="$t('sidebar.validator')"  icon="tim-icons icon-key-25" to="/validator"/>
        <sidebar-link :name="$t('sidebar.launcher')"  icon="tim-icons icon-components" to="/launcher"/>
      </template>
    </side-bar>
